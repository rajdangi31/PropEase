    ...
    <div className="flex h-full flex-col text-sidebar-foreground">
      ...
      <div className="px-3 pb-3">
        {user.role === "maintenance" || user.role === "service" ? (
          <div className="flex w-full items-center justify-between rounded-lg bg-sidebar-accent px-3 py-2.5 text-left text-sm">
        ...
        {adminNav
          .filter((item) => {
            if (user.role === "maintenance" || user.role === "service") {
              return item.to === "/admin/maintenance" || item.to === "/admin/notifications";
            }
            return true;
          })
          .map((item) => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className="hidden w-64 shrink-0 bg-sidebar md:block">
        <AdminSidebar properties={properties} activeProperty={activeProperty} user={user} />
      </aside>
