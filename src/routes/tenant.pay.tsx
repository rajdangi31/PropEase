    ...
    if (sessionId) {
      const verifyPayment = async () => {
        ...
        try {
          ...
          setMessage({
            type: "success",
            text: "Rent payment processed and verified successfully via Stripe Checkout!",
          });
          // Clear query params
          ...
          setMessage({
            ...
            text:
              err.message ||
              "Failed to verify Stripe payment. Please check your card or contact support.",
          });
        } finally {
    ...
    return (
      <div className="flex min-h-[400px] flex-col items-center justify-center text-center p-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground max-w-sm">
          Please wait while we confirm your payment details with Stripe and secure your rent
          transaction receipt.
        </p>
      </div>
    );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Manage your rent payments and check your billing ledger
        </p>
      </div>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                  You don't have an active lease yet. Once your landlord assigns you to a unit,
              ...
              <CardContent className="p-6 space-y-6">
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold">
                        {message.type === "success" ? "Success" : "Payment Issue"}
                      </p>
                ...
                <div className="rounded-2xl bg-muted/40 border border-border/50 p-6 flex flex-col items-center text-center justify-center space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
                    Due date:{" "}
                    <span className="font-medium text-foreground">{dashboard.dueDate}</span>
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    {isPaying
                      ? "Launching Gateway..."
                      : `Pay $${dashboard.balance.toLocaleString()} securely`}
                  </Button>

                  <div className="flex flex-col items-center justify-center space-y-3">
                    <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
                      <ShieldCheck className="h-4 w-4 text-success" /> Payments are encrypted and
                      secured by Stripe.
                    </p>
                    <div className="flex gap-2 opacity-50 grayscale hover:opacity-70 hover:grayscale-0 transition-all">
                      <img
                        src="https://js.stripe.com/v3/fingerprinted/img/visa-72545d4e12e177fcb348db4974f115a3.svg"
                        className="h-6"
                        alt="Visa"
                      />
                      <img
                        src="https://js.stripe.com/v3/fingerprinted/img/mastercard-a12f6c0143899db9e92cf4de7c9e05fa.svg"
                        className="h-6"
                        alt="Mastercard"
                      />
                      <img
                        src="https://js.stripe.com/v3/fingerprinted/img/amex-910fa16857addf9eec45c38e4a9e224e.svg"
                        className="h-6"
                        alt="Amex"
                      />
                      <img
                        src="https://js.stripe.com/v3/fingerprinted/img/discover-4df15a6b7d346ff175d7b5bf46d7e0f2.svg"
                        className="h-6"
                        alt="Discover"
                      />
                    </div>
        ...
        <div>
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <Badge variant="secondary" className="mt-2 w-full justify-center py-1.5">
                Auto-pay available
              </Badge>
            </CardContent>
          </Card>
                ...
                <div className="border-t border-border pt-4 grid grid-cols-2 gap-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium mt-0.5">
                      ...
                      selectedPaymentForReceipt.transactionId.startsWith("cs_")
                        ? "Stripe Checkout"
                  ...
                  {selectedPaymentForReceipt.transactionId && (
                    <div className="col-span-2">
                      ...
                      <p className="font-mono text-xs mt-0.5 break-all text-muted-foreground bg-muted p-2 rounded">
                        {selectedPaymentForReceipt.transactionId}
                      </p>
                    </div>
                  )}
